...
},{"./todoList.jsx":161,"react":157}],159:[function(require,module,exports){
var React = require('react');
  ...
  render: function () {
    return (
        React.createElement("div", null, 
          ...
          React.createElement("form", {className: "todo-input", id: "formAddToDo", onSubmit: this.submit}, 
              React.createElement("input", {id: "inputToDoList", type: "text", placeholder: "What needs to be done?", ref: "task"})
          )
        )
    );
  }
  ...
  render: function () {
    return (
      React.createElement("li", null, 
        React.createElement("input", {type: "checkbox", onClick: this.toggle, checked: this.props.done}), 
        React.createElement("label", {className: this.props.done ? "done" : ""}, this.props.task), 
        React.createElement("a", {id: "delete-btn", onClick: this.removeTask}, "x")
      )
    );
  }
});
  ...
  render: function () {
    return (
      React.createElement("div", {id: "todoapp"}, 
        React.createElement(Form, {onSubmit: this.add, onToggleAll: this.toggleAll}), 

        React.createElement("section", {id: "main"}), 
          React.createElement("input", {id: "toggle-all", type: "checkbox", ref: "_check", value: this.state.checkboxValue, onChange: this.toggleAll}), 
            ...
            if (items.length > 0) {
              ...
              return (
                React.createElement("footer", null, 
                  React.createElement("a", {id: "clear-completed", onClick: this.clearCompleted}, itemsDone.length, " completed item(s)"), 
                  React.createElement("div", null, React.createElement("b", null, items.length), " item left")
                )
              );
            }
          })(this.state.data)
...
},{"./form.jsx":159,"./task.jsx":160,"jquery":1,"react":157}]},{},[158]);
